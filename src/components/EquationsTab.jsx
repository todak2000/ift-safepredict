...
const BOUNDS_SUB = [
  ['P_r', '0.0136', '4.695'],
  ['T_r', '0.9149', '2.2172'],
  ['(\\Delta\\rho)^2', '0.000132', '1.2949'],
  ['\\text{MCM}', '0', '4.9'],
  ['\\text{BCM}', '0', '1.5'],
  ['x_{\\text{CH}_4}', '0', '0.890'],
  ['x_{\\text{N}_2}', '0', '0.7636'],
]

const BOUNDS_SUP = [
  ['P_r', '1.011', '4.457'],
  ['T_r', '1.002', '1.258'],
  ['(\\Delta\\rho)^2', '0.001', '0.198'],
  ['\\text{MCM}', '0', '4.880'],
  ['\\text{BCM}', '0', '1.480'],
  ['x_{\\text{CH}_4}', '0', '0.200'],
  ['x_{\\text{N}_2}', '0', '0.150'],
]
...
\\hat{\\gamma}_{\\mathrm{sub}} ={}&
  64.0498 \\\\[2pt]
{}+{}& 16.6495\\; h^{+}(\\tilde{d},\\;0.0282) \\\\
{}+{}& 257.602\\; h^{-}(\\tilde{d},\\;0.0282) \\\\
{}+{}& 28.2755\\; h^{+}(\\tilde{P}_r,\\;{-}0.7198) \\\\
{}-{}& 26.3285\\; h^{-}(\\tilde{P}_r,\\;{-}0.7198) \\\\
{}+{}& 71.5226\\; h^{+}(\\tilde{T}_r,\\;{-}0.3956) \\\\
{}-{}& 253.018\\; h^{-}(\\tilde{T}_r,\\;{-}0.3956) \\\\
{}+{}& 286.742\\; h^{-}(\\tilde{P}_r,\\;{-}0.7198)\\cdot h^{+}(\\tilde{T}_r,\\;{-}0.518) \\\\
{}-{}& 66.4681\\; h^{-}(\\tilde{P}_r,\\;{-}0.7198)\\cdot h^{-}(\\tilde{T}_r,\\;{-}0.518) \\\\
{}-{}& 103.870\\; h^{+}(\\tilde{P}_r,\\;{-}0.7198)\\cdot h^{+}(\\tilde{d},\\;{-}0.7039) \\\\
{}+{}& 67.0262\\; h^{+}(\\tilde{P}_r,\\;{-}0.7198)\\cdot h^{-}(\\tilde{d},\\;{-}0.7039) \\\\
{}+{}& 264.746\\; h^{+}(\\tilde{T}_r,\\;{-}0.516)\\cdot h^{+}(\\tilde{d},\\;0.0282) \\\\
{}-{}& 476.576\\; h^{-}(\\tilde{T}_r,\\;{-}0.516)\\cdot h^{+}(\\tilde{d},\\;0.0282) \\\\
{}+{}& 76.4994\\; h^{+}(\\tilde{T}_r,\\;{-}0.8978)\\cdot h^{-}(\\tilde{d},\\;0.0282) \\\\
{}-{}& 58.3818\\; h^{-}(\\tilde{T}_r,\\;{-}0.8978)\\cdot h^{-}(\\tilde{d},\\;0.0282) \\\\
{}-{}& 34.7719\\; h^{+}(\\tilde{T}_r,\\;{-}0.7481) \\\\
{}+{}& 184.676\\; h^{+}(\\tilde{T}_r,\\;{-}0.516) \\\\
...
{}+{}& 84.6131\\; h^{-}(\\tilde{d},\\;0.4517) \\\\
{}-{}& 32.9950\\; h^{+}(\\tilde{n},\\;0.9652) \\\\
{}-{}& 64.0876\\; h^{-}(\\tilde{n},\\;0.9652) \\\\
{}+{}& 3.4684\\; h^{+}(\\tilde{c},\\;0.7966) \\\\
{}-{}& 8.4184\\; h^{-}(\\tilde{c},\\;0.7966) \\\\
{}-{}& 1959.30\\; h^{+}(\\widetilde{\\mathrm{BCM}},\\;{-}0.64)\\cdot h^{-}(\\tilde{d},\\;0.4517) \\\\
{}+{}& 34.4304\\; h^{-}(\\widetilde{\\mathrm{BCM}},\\;{-}0.64)\\cdot h^{-}(\\tilde{d},\\;0.4517) \\\\
{}+{}& 3.1914\\; h^{+}(\\tilde{T}_r,\\;{-}0.5087)\\cdot h^{-}(\\tilde{d},\\;0.4517) \\\\
{}-{}& 8.6816\\; h^{-}(\\tilde{T}_r,\\;{-}0.5087)\\cdot h^{-}(\\tilde{d},\\;0.4517) \\\\
{}+{}& 4.2350\\; h^{+}(\\widetilde{\\mathrm{MCM}},\\;{-}0.802)\\cdot h^{-}(\\tilde{d},\\;0.4517) \\\\
{}-{}& 29.5554\\; h^{-}(\\widetilde{\\mathrm{MCM}},\\;{-}0.802)\\cdot h^{-}(\\tilde{d},\\;0.4517) \\\\
{}+{}& 31.1754\\; h^{+}(\\tilde{T}_r,\\;{-}0.7733)\\cdot h^{-}(\\tilde{n},\\;0.9652) \\\\
{}+{}& 1733.77\\; h^{-}(\\tilde{T}_r,\\;{-}0.7733)\\cdot h^{-}(\\tilde{n},\\;0.9652) \\\\
{}+{}& 302.237\\; h^{+}(\\tilde{T}_r,\\;{-}0.7165)\\cdot h^{-}(\\tilde{d},\\;0.4517) \\\\
{}+{}& 28.3565\\; h^{+}(\\tilde{T}_r,\\;{-}0.499)\\cdot h^{-}(\\tilde{d},\\;0.4517) \\\\
{}-{}& 136.493\\; h^{+}(\\tilde{T}_r,\\;{-}0.5359)\\cdot h^{-}(\\tilde{d},\\;0.4517)
\\end{aligned}`

const EQ_SUP_MARS_B = `\\begin{aligned}
{}-{}& 133.979\\; h^{+}(\\tilde{P}_r,\\;{-}0.9628)\\cdot h^{-}(\\tilde{c},\\;0.7966) \\\\
{}+{}& 126.039\\; h^{-}(\\tilde{P}_r,\\;{-}0.9628)\\cdot h^{-}(\\tilde{c},\\;0.7966) \\\\
{}+{}& 8.6252\\; h^{+}(\\tilde{T}_r,\\;{-}0.437)\\cdot h^{-}(\\tilde{d},\\;0.4517) \\\\
{}-{}& 13.5765\\; h^{-}(\\tilde{c},\\;0.7966)\\cdot h^{+}(\\tilde{n},\\;{-}0.3434) \\\\
{}+{}& 21.9898\\; h^{-}(\\tilde{c},\\;0.7966)\\cdot h^{+}(\\tilde{n},\\;{-}0.3675) \\\\
{}-{}& 20.8103\\; h^{-}(\\widetilde{\\mathrm{BCM}},\\;{-}1)\\cdot h^{+}(\\tilde{d},\\;0.4517) \\\\
{}+{}& 24.6178\\; h^{+}(\\tilde{P}_r,\\;{-}0.8438)\\cdot h^{-}(\\tilde{n},\\;0.9652) \\\\
{}+{}& 24.9711\\; h^{-}(\\tilde{P}_r,\\;{-}0.8438)\\cdot h^{-}(\\tilde{n},\\;0.9652) \\\\
{}-{}& 19.7154\\; h^{+}(\\tilde{n},\\;0.2907)\\cdot h^{-}(\\tilde{d},\\;0.4517) \\\\
{}+{}& 2.3966\\; h^{-}(\\tilde{n},\\;0.2907)\\cdot h^{-}(\\tilde{d},\\;0.4517) \\\\
{}+{}& 68.8340\\; h^{+}(\\tilde{P}_r,\\;{-}0.7159) \\\\
{}+{}& 3.7786\\; h^{-}(\\tilde{P}_r,\\;{-}0.7159) \\\\
{}+{}& 5.3720\\; h^{+}(\\widetilde{\\mathrm{BCM}},\\;{-}0.982)\\cdot h^{-}(\\tilde{n},\\;0.9652) \\\\
{}-{}& 31.8591\\; h^{-}(\\widetilde{\\mathrm{BCM}},\\;{-}0.982)\\cdot h^{-}(\\tilde{n},\\;0.9652) \\\\
{}+{}& 11.3604\\; h^{+}(\\tilde{T}_r,\\;{-}0.3379)\\cdot h^{-}(\\tilde{c},\\;0.7966) \\\\
{}+{}& 25.7311\\; h^{-}(\\tilde{T}_r,\\;{-}0.3379)\\cdot h^{-}(\\tilde{c},\\;0.7966) \\\\
{}-{}& 133.286\\; h^{+}(\\tilde{c},\\;{-}0.7551)\\cdot h^{-}(\\tilde{n},\\;0.9652)
\\end{aligned}`
