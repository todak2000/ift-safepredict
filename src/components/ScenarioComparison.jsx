...
const STATUS_COLORS = { GREEN: '#22c55e', AMBER: '#eab308', RED: '#ef4444' }
        ...
        {scenarios.map((s, i) => (
          <div key={i} className="scenario-card">
            ...
            <div style={{ fontSize: '0.72rem', color: '#94a3b8', marginTop: '0.25rem' }}>
              [{Math.min(s.result.p10, s.result.p90).toFixed(1)} – {Math.max(s.result.p10, s.result.p90).toFixed(1)}] mN/m
            </div>
